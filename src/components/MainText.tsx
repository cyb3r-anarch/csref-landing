...
export default function MainText({ curTheme }: MainTextProps) {
  return (
    <div className=' h-96 mt-32 ml-auto mb-16 mr-auto sm:container text-center px-96 gap-y-8 flex flex-col '>
      ...
      <p className='text-lg text-slate-300'>The most convinient way for merchants in Africa to easily accept mobile money, crypto, cash payments and third-party wallet services from their customers</p>
